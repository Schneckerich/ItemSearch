package de.schneckt.itemsearch.v1_21_8.widgets;
...
import net.labymod.v1_21_8.client.gui.screen.widget.converter.TextFieldConverter;
    ...
    public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        Laby.labyAPI().minecraft().updateMouse((double)mouseX, (double)mouseY, (mouse) -> {
            ...
            screenContext.runInContext(
                Stack.create(JomlMatrix3x2fStackProvider.fromGuiGraphics(graphics)),
                mouse,
                partialTicks,
                context -> {
                context.canvas().ensureAutoBlitMainTarget(() -> this.searchBoxWidget.render(context));
            });
        });
    }
